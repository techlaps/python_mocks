...
from main_joke_3 import len_joke, get_joke


class TestJoke_3(unittest.TestCase):
    @patch('main_joke_3.get_joke')
    def test_len_joke(self, mock_get_joke):
        mock_get_joke.return_value = "one"
        self.assertEqual(len_joke(), 3)

    @patch('main_joke_3.requests')
    ...
    '''@patch('main_joke_3.requests')
    def test_get_joke_raise_for_status_2(self, mock_requests):
